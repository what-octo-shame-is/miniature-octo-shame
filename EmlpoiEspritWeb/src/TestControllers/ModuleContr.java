...
@ManagedBean(name = "moduleContr")
@ApplicationScoped
public class ModuleContr {
	@EJB
	Services serviceAdmin;
	Set<Module> seMSG = new HashSet<Module>();
	@ManagedProperty(value = "#{controllers}")
	...
	private List<Module> selectedPlayers = new ArrayList<Module>();
	 private List<Module> liste = new ArrayList<Module>();
	public ModuleContr() {
		super();
	...
	public Controllers getControllers() {
		if (controllers == null) {
			...
			controllers = new Controllers(serviceAdmin);
